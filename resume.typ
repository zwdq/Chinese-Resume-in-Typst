...
人生苦短, 希望自己永远面临挑战, 与有趣的人一起解决困难的事。你好，我是乾栋， 在大数据、机器学习领域已有6年经验, 热爱技术, 热爱代码, 目前在中金公司任数据分析师。
]
...
- 基于P-Tuning-v2、LoRA微调Llama等模型, 实现垂类场景模型效果提升, 并通过模型自我蒸馏、NEFTune等技术, 减少微调造成的灾难性遗忘和幻觉。
